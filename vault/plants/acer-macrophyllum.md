---
type: plant
title: Acer macrophyllum (Big Leaf Maple)
aliases: [Bigleaf Maple, Oregon Maple]
tags: [native, tree]
status: stub
sources:
...
native:
  ...
  attracts_wildlife: [Bats, Birds, Caterpillars]
  plant_type_raw: "Tree"
  ...
  soil_ph: "5.5 - 7.5"
  communities: [Chaparral, Douglas-Fir Forest, Foothill Woodland, Mixed Evergreen Forest, Red Fir Forest, Redwood Forest, Valley Grassland, Wetland-Riparian, Yellow Pine Forest]
  communities_simplified: [Chaparral, Forest, Grassland, Wetland/Riparian, Woodland]
  companions: [Platanus racemosa, Alnus rhombifolia, Umbellularia californica, Pseudotsuga menziesii, Pinus ponderosa, Abies magnifica]
  ...
  rarity: "Common"
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Acer+macrophyllum"
  calscape_url: "https://calscape.org/Acer-macrophyllum-%28Big-Leaf-Maple%29"
  retrieved: 2026-05-17
---

# Acer macrophyllum (Big Leaf Maple)

Acer macrophyllum (Big Leaf Maple) is a California-native tree of Chaparral, Forest, Grassland, Wetland/Riparian, Woodland. Calscape records **87** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Acer+macrophyllum).
