---
type: plant
title: Agrostis pallens (Thingrass)
aliases: [Seashore Bent Grass, Seashore Bentgrass, Thin Bentgrass]
...
scientific_name: Agrostis pallens
common_names: [Thingrass]
plant_type: grass
nativity: native
...
native:
  ...
  soil_ph: "5.0 - 8.0"
  communities: [Chaparral, Coastal Strand, Foothill Woodland, Lodgepole Forest, Red Fir Forest, Subalpine Forest, Valley Grassland, Yellow Pine Forest]
  ...
  rarity: "Common"
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Agrostis+pallens"
  calscape_url: "https://calscape.org/Agrostis-pallens-%28Thingrass%29"
  retrieved: 2026-05-17
---

# Agrostis pallens (Thingrass)

Agrostis pallens (Thingrass) is a California-native grass of Chaparral, Coastal Scrub, Forest, Grassland, Woodland. Calscape records **4** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Agrostis+pallens).
