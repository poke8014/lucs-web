---
type: plant
title: Gilia capitata (Blue Field Gilia)
aliases: [Blue Field-gilia, Bluehead Gilia]
...
native:
  ...
  soil_ph: "6.0 - 7.0"
  communities: [Chaparral, Coastal Prairie, Coastal Sage Scrub, Coastal Strand, Douglas-Fir Forest, Foothill Woodland, Mixed Evergreen Forest, Northern Coastal Scrub, Red Fir Forest, Yellow Pine Forest]
  communities_simplified: [Chaparral, Coastal Scrub, Forest, Grassland, Woodland]
  companions: [Eschscholzia californica, Nemophila menziesii, Delphinium cardinale]
  sunset_zones: ""
  hardiness: "Tolerates cold to -20° F"
  nursery_availability: "Commonly Available"
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Gilia+capitata"
  calscape_url: "https://calscape.org/Gilia-capitata-%28Blue-Field-Gilia%29"
  retrieved: 2026-05-17
---

# Gilia capitata (Blue Field Gilia)

Gilia capitata (Blue Field Gilia) is a California-native annual of Chaparral, Coastal Scrub, Forest, Grassland, Woodland. Calscape records **5** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Soil pH:** 6.0 - 7.0
- **Soil notes:** Tolerates clay but does best in well-drained soil
- **Ease of care:** Moderate
- **Propagation:** For propagating by seed:  No treatment; 2 wks. stratification improves germination ( Grant 1949).
- **Tips:** Prefers sun. Likes sandy rocky soils.
...
- **Plant communities:** Chaparral, Coastal Prairie, Coastal Sage Scrub, Coastal Strand, Douglas-Fir Forest, Foothill Woodland, Mixed Evergreen Forest, Northern Coastal Scrub, Red Fir Forest, Yellow Pine Forest
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Gilia+capitata).
