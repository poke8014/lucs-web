---
type: plant
title: Senecio flaccidus (Threadleaf Ragwort)
aliases: [Douglas Senecio, Threadleaf Groundsel, Bush Senecio, Creek Senecio]
...
scientific_name: Senecio flaccidus
common_names: [Threadleaf Ragwort]
plant_type: shrub
nativity: native
...
native:
  ...
  sun_range: "Full Sun"
  water_range: "Extremely Low, Very Low"
  ease_of_care: ""
  soil_drainage: [Fast]
  soil_ph: ""
  communities: []
  ...
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Senecio+flaccidus"
  calscape_url: "https://calscape.org/Senecio-flaccidus-%28Threadleaf-Ragwort%29"
  retrieved: 2026-05-17
---

# Senecio flaccidus (Threadleaf Ragwort)

Senecio flaccidus (Threadleaf Ragwort) is a California-native shrub of California. Calscape records **26** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Soil drainage:** Fast
- **Tips:** Prefers sun. Likes dry rocky and sandy soils.
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Senecio+flaccidus).
