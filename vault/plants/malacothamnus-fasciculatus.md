---
type: plant
title: Malacothamnus fasciculatus (Chaparral Mallow)
aliases: [Chaparral Bushmallow]
...
scientific_name: Malacothamnus fasciculatus
common_names: [Chaparral Mallow]
plant_type: shrub
nativity: native
...
native:
  ...
  attracts_wildlife: [Birds, Butterflies, Hummingbirds, Caterpillars]
  ...
  companions: [Encelia californica, Prunus ilicifolia]
  sunset_zones: ""
  hardiness: "Tolerates cold to 15° F"
  nursery_availability: "Commonly Available"
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Malacothamnus+fasciculatus"
  calscape_url: "https://calscape.org/Malacothamnus-fasciculatus-%28Chaparral-Mallow%29"
  retrieved: 2026-05-17
---

# Malacothamnus fasciculatus (Chaparral Mallow)

Malacothamnus fasciculatus (Chaparral Mallow) is a California-native shrub of Chaparral, Coastal Scrub, Woodland. Calscape records **4** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Malacothamnus+fasciculatus).
