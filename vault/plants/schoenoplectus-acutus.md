...
native:
  ...
  companions: []
  sunset_zones: ""
  hardiness: "Tolerates cold to -5 - 5° F"
  nursery_availability: "Commonly Available"
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Schoenoplectus+acutus"
  calscape_url: "https://calscape.org/Schoenoplectus-acutus-%28Hardstem-Bulrush%29"
  retrieved: 2026-05-17
---

# Schoenoplectus acutus (Hardstem Bulrush)

Schoenoplectus acutus (Hardstem Bulrush) is a California-native grass of Wetland/Riparian. Calscape records **7** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Cold hardiness:** Tolerates cold to -5 - 5° F
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Schoenoplectus+acutus).
