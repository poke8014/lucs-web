...
aliases: [Red-tinge Bulrush, Smallfruit Bulrush]
...
native:
  ...
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Scirpus+microcarpus"
  calscape_url: "https://calscape.org/Scirpus-microcarpus-%28Panicled-Bulrush%29"
  retrieved: 2026-05-17
---

# Scirpus microcarpus (Panicled Bulrush)

Scirpus microcarpus (Panicled Bulrush) is a California-native grass of Chaparral, Forest, Grassland, Wetland/Riparian, Woodland. Calscape records **7** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Special uses:** Water features or wet habitats
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Scirpus+microcarpus).
