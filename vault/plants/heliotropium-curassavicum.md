---
type: plant
title: Heliotropium curassavicum (Seaside Heliotrope)
aliases: [Quail Plant, Salt Heliotrope, Monkey Tail]
...
scientific_name: Heliotropium curassavicum
common_names: [Seaside Heliotrope]
...
native:
  ...
  soil_drainage: []
  soil_ph: ""
  communities: [Chaparral, Foothill Woodland, Lodgepole Forest, Red Fir Forest, Valley Grassland, Wetland-Riparian, Yellow Pine Forest]
  ...
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Heliotropium+curassavicum"
  calscape_url: "https://calscape.org/Heliotropium-curassavicum-%28Seaside-Heliotrope%29"
  retrieved: 2026-05-17
---

# Heliotropium curassavicum (Seaside Heliotrope)

Heliotropium curassavicum (Seaside Heliotrope) is a California-native perennial of Chaparral, Forest, Grassland, Wetland/Riparian, Woodland. Calscape records **2** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Sun:** Full Sun
- **Water:** Moderate, High
- **Soil notes:** Grows in many soil types, often in saline or alkaline soils.
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Heliotropium+curassavicum).
