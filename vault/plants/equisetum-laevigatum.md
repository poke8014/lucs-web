---
type: plant
title: Equisetum laevigatum (Horsetail)
aliases: [Smooth Horsetail, Smooth Scouring-rush, Smooth Scouringrush, Smooth Scouring Rush]
tags: [native, perennial]
status: stub
sources:
  - https://calscape.org/export/search/?lat=<lat>&lng=<lng>  # Calscape export — see sources/calscape.md
last_updated: 2026-05-17

scientific_name: Equisetum laevigatum
common_names: [Horsetail]
...
native:
  ...
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Equisetum+laevigatum"
  calscape_url: "https://calscape.org/Equisetum-laevigatum-%28Horsetail%29"
  retrieved: 2026-05-17
---

# Equisetum laevigatum (Horsetail)

Equisetum laevigatum (Horsetail) is a California-native perennial of Chaparral, Forest, Grassland, Wetland/Riparian, Woodland. Calscape records **0** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- **Water:** High, Moderate
- **Soil drainage:** Fast
- **Soil notes:** Prefers loamy or clay soils.  Grows poorly in sandy soils.
- **Ease of care:** Moderate
- **Tips:** Plant in loamy or clay soils that are at least 10 inches deep, with a pH of 4.5-6.5. It is tolerant of anaerobic soils, intolerant of calcareous soils, and tolerant of infertile soils. Equisetum laevigatum is not drought tolerant. It requires a minimum of 10 inches of water per year, and a maximum of 45 inches of water per year once established. Requires moist soil. Prefers shade.
...
- **Special uses:** Water features or wet habitats, Deer resistant
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Equisetum+laevigatum).
