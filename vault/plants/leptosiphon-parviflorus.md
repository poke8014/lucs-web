---
type: plant
title: Leptosiphon parviflorus (Variable Linanthus)
aliases: [Common Linanthus]
tags: [native, annual]
status: stub
sources:
...
scientific_name: Leptosiphon parviflorus
common_names: [Variable Linanthus]
plant_type: annual
nativity: native
pollinators: []
water:
...
native:
  ...
  rarity: ""
  is_cultivar: false
  jepson_url: "https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Leptosiphon+parviflorus"
  calscape_url: "https://calscape.org/Leptosiphon-parviflorus-%28Variable-Linanthus%29"
  retrieved: 2026-05-17
---

# Leptosiphon parviflorus (Variable Linanthus)

Leptosiphon parviflorus (Variable Linanthus) is a California-native annual of California. Calscape records **0** butterfly/moth species supported. _Structured data only — full description and named host species pending the Calscape page-scrape enrichment pass (see [[sources/calscape]])._
...
- Jepson eFlora — [taxon record](https://ucjeps.berkeley.edu/eflora/eflora_display.php?name=Leptosiphon+parviflorus).
